...
class WaypointUpdater(object):
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            if self.pose and self.base_waypoints:
                ...
                #rospy.loginfo("CLosest Waypoint :{}".format(closest_waypoint_idx))
    ...
    def pose_cb(self, msg):
        # TODO: Implement
        self.pose = msg #50Hz
        #rospy.loginfo("Pose Recieved :{}".format(self.pose))


    def waypoints_cb(self, waypoints):
        # TODO: Implement
        self.base_waypoints =  waypoints
        rospy.loginfo("Base Waypoints Recieved")
    ...
    def traffic_cb(self, msg):
        ...
        #rospy.loginfo("Traffic Waypoint received {}".format(self.stop_line_idx))
    ...
    def decelerate_waypoints(self, base_waypoints, closest_idx):
         ...
         for i , wp in enumerate(base_waypoints):
            ...
            #updated_wp_vel = min(vel, self.get_waypoint_velocity(wp)
             #self.set_waypoint_velocity(waypoints, wp, updated_wp_vel)
